...
//usables grasslands
    'firecracker': {'metatype': 'usable', 'price': 5, 'description': 'During combat, use to deal 20 damage (bypasses armor) to the current enemy, lose 2 hp', 'type': 'combat', 'enemyDmg': 20, 'hp': -2},
    'throwing eggs': {'metatype': 'usable', 'price': 7, 'description': "During combat, lower the current enemy's armor by 3", 'type': 'combat', 'enemyArm': -3},
    'bandages': {'metatype': 'usable', 'price': 9, 'description': 'Heal 5', 'type': 'all', 'hp': 5},
    'first aid kit': {'metatype': 'usable', 'price': 8, 'description': 'Heal 20', 'type': 'all', 'hp': 20},
    'sharpening stone': {'metatype': 'usable', 'price': 26, 'description': 'Your currently equipped weapon gains +2 dmg', 'type': 'all', 'weaponDmg': 2},

//usables forest
    'goblin bomb': {'metatype': 'usable', 'price': 20, 'count': 1, 'description': 'During combat, use to deal 50 dmg (bypasses armor) to the current enemy. If the current enemy is of the goblin type, instead deal 0 damage. Gain 5 gold', 'type': 'combat', 'enemyDmgNonGoblin': 50, 'gold': 5},
    'dryad throwing leaves': {'metatype': 'usable', 'price': 28, 'count': 4, 'description': 'During combat, deal 10 dmg to an enemy (bypasses armor), and heal 10', 'type': 'combat', 'enemyDmg': 10, 'hp': 10},
    'elf bandages': {'metatype': 'usable', 'price': 35, 'count': 15, 'description': 'Heal 10', 'type': 'all', 'hp': 10},
    'elven battle book': {'metatype': 'usable', 'price': 18, 'count': 1, 'description': 'During combat, if enemy has a lower total attackspeed than you, gain 3% permanent dodge', 'type': 'combat', 'conditionalDodge': 3},
    'dryad battle book': {'metatype': 'usable', 'price': 22, 'count': 1, 'description': 'During combat, if enemy has a higher total attackspeed than you, gain 3% permanent lifedrain', 'type': 'combat', 'conditionalLifedrain': 3},
    'goblin sacks': {'metatype': 'usable', 'price': 30, 'count': 4, 'description': 'During combat, gain 20% of the current enemy\'s gold pay out', 'type': 'combat', 'enemyGoldPayout': 0.2},
    'dryad berries': {'metatype': 'usable', 'price': 41, 'count': 4, 'description': 'Heal 15 hp and gain 1 regen permanetly', 'type': 'all', 'hp': 15, 'regen': 1},
    'pine needle attachments': {'metatype': 'usable', 'price': 58, 'count': 4, 'description': 'Your currently equipped weapon gains +5 dmg', 'type': 'all', 'weaponDmg': 5},
    'pine cone attachments': {'metatype': 'usable', 'price': 62, 'count': 5, 'description': 'Your currently equipped weapon gains +3 shatter', 'type': 'all', 'weaponShatter': 3},
    'elven nectar': {'metatype': 'usable', 'price': 45, 'count': 2, 'description': 'During combat, all armor you have lost due to your opponent\'s shatter this combat is removed. However, more shatter can still be gained', 'type': 'combat', 'removeShatter': True},
    'dryad root potion': {'metatype': 'usable', 'price': 70, 'count': 1, 'description': 'During combat, the enemy\'s base armor grows by the amount of effective armor they currently have (armor - shatter applied). Their attackspeed is set to half.', 'type': 'combat', 'enemyArmDouble': True, 'enemyAsHalf': True},
...
//magic grasslands
    'shock': {'metatype': 'magic', 'price': 15, 'shortDescription': 'deal 10 dmg', 'longDescription': 'Deal 10 dmg to the current enemy. Does not bypass armor or dodge. Infinite uses', 'manaCost': 12, 'enemyDmg': 10},
...
//magic forest
    ...
    'rock drop': {'metatype': 'magic', 'price': 38, 'shortDescription': 'deal 40 dmg', 'longDescription': 'Deal 40 dmg to the current enemy. Does not bypass armor or dodge. Infinite uses', 'manaCost': 15, 'enemyDmg': 40},
...
//boss items grasslands
    ...
    'barbed wire blade': {'metatype': 'weapon', 'price': 5, 'type': 'knife', 'dmg': 15, 'regen': -2, 'as': 66, 'bleed' : 20, 'message': 'In the calamity of combat, a barbed wire fence has been bound up tightly into a blade. Razor sharp, even on the handle'},
    'golden garden hoe': {'metatype': 'weapon', 'price': 5, 'type': 'sword', 'dmg': 24, 'as': -20, 'income': 2, 'message': 'Rooting through the carnage, you notice the glimmer of gold surprisingly fashioned to an ordinary tool. Basic, but shiny'},
