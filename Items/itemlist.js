...
const ITEMLIST = {
  ...
  'whale tooth axe': [135, '(70 dmg +3 regen -25 speed +160 shatter axe)','weapon',['axe',70,0,3,-25,{'shatter':160}]],
  // turtlean cross bow



  'iron helmet': [55, '(+8 armor -10 speed hat)', 'head', ['hat', 0, 8, 0, -10]],
  'steel helmet': [80, '(+12 armor -10 speed hat)', 'head', ['hat', 0, 12, 0, -10]],
  'sailor cap': [60, '(3 armor +15 speed hat)', 'head', ['hat', 0, 3, 0, 15]],
  'pirate hat': [90, '(6 armor +15 dmg +15 speed +3 income hat)', 'head', ['hat', 15, 6, 0, 15, {'income':3}]],
  'mermaid headress': [110, '(+15 regen -10 speed headband)', 'head', ['headband', 0, 0, 15, -10]],
  'turtle shell-met': [95, '(+30 armor -50 speed helmet)', 'head', ['helmet', 0, 30, 0, -50]],
  'razor seaweed hair': [78, '(+8 armor +5 speed +12 thorn hair)', 'head', ['hair', 0, 8, 0, 5, {'thorn':12}]],
  'rubber boot hat': [40, '(+5 armor +10 speed hat)', 'head', ['hat', 5, 0, 0, 10]],
  'crabwalker beret': [80, '(+7 armor +15 lifedrain +8 thorn hat)', 'head', ['hat',0,7,0,0,{'lifedrain':15,'thorn':8}]],
  'paperboat hat': [64, '(+5 armor +5 dmg +5 shatter hat)', 'head', ['hat',5,5,0,0,{'shatter':5}]],
  'crabwalker fedora': [80, '(+11 armor +20 speed +8 thorn hat)', 'head', ['hat',0,11,0,20,{'thorn':8}]],
  'fisherman bucket hat': [75, '(+9 armor +6 regen +6 dmg -10 speed hat)', 'head', ['hat', 6, 9, 6, -10, {'income':2}]],
  'coconut helmet': [99, '(+16 armor +10 lifedrain -15 speed hat)', 'head', ['hat', 0, 16, 0, -15, {'lifedrain':10}]],
  

  
  'iron chestplate': [80, '(14 armor -12 speed chestplate)', 'chest', ['chestplate', 0, 14, 0, -12]],
  'steel chestplate': [105, '(19 armor -8 speed chestplate)', 'chest', ['chestplate', 0, 19, 0, -8]],
  'seashell chestplate': [100, '(16 armor -8 speed +5 thorn chestplate)', 'chest', ['chestplate', 0, 16, 0, -8, {'thorn':5}]],
  'sharkskin vest': [120, '(15 armor -20 speed +10 bleed vest)', 'chest', ['vest', 0, 15, 0, -20, {'bleed':10}]],
  'coral chestplate': [95, '(18 armor -40 speed +12 thorns chestplate)', 'chest', ['chestplate', 0, 18, 0, -40, {'thorn':12}]],
  'turtlean shell': [140, '(50 armor -80 speed chestplate)', 'chest', ['chestplate', 0, 50, 0, -80]],
  'seaweed wrap': [20, '(11 armor +5 lifedrain chest)', 'chest', ['misc', 0, 11, 0, 0, {'lifedrain':5}]],
  'taped water bags': [100, '(20 armor +11 dodge chest)', 'chest', ['chest', 0, 20, 0, 0, {'dodge':11}]],
