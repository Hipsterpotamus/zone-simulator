...
//dropped usables grasslands
    ...
    'bug spray': {'metatype': 'usable', 'price': 0, 'uses': 1, 'shortDescription': 'deal 99999 dmg to bug type enemy', 'longDescription': 'During combat, if the current enemy is bug type, deal 99999 dmg', 'type': 'combat', 'killBug':true},
    ...
    'nectar': {'metatype': 'usable', 'price': 0, 'uses': 1, 'shortDescription': 'gain 2 temporary regen', 'longDescription': 'During combat, use to gain 2 regen until end of combat', 'type': 'combat', 'tempRegen':2},
    'insect wings': {'metatype': 'usable', 'price': 0, 'uses': 2, 'shortDescription': 'gain 5 temporary speed and 1 temporary dmg', 'longDescription': 'During combat, use to gain 5 attack speed and 1 dmg until end of combat', 'type': 'combat', 'tempSpeed':5, 'tempDmg':1},
